    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navbar class="me-1.5 space-x-0.5 rtl:space-x-reverse py-0!">
                ...
                <flux:tooltip :content="__('Landing Page')" position="bottom">
                    <flux:navbar.item
                ...
                <flux:tooltip :content="__('Panduan Pengajuan')" position="bottom">
                    <flux:navbar.item
                        class="h-10 max-lg:hidden [&>div>svg]:size-5"
                        icon="book-open-text"
                        href="{{ route('home') }}#alumni-section"
                        :label="__('Panduan Pengajuan')"
                        wire:navigate
                    />
                </flux:tooltip>
            </flux:navbar>
